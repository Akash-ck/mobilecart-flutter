          ...
          Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text('AKASH CK',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
            ...
            children: drawerItems.map((element) => Padding(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text(element['title'],style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 15))
                ],
